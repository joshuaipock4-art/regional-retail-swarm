...
# Ensure idm folder is in path for relative package imports
...
app = FastAPI(
    ...
    description="Consolidated Swarm Engine for automated retail operations.",
    version="1.0.0"
)
...
def run_a1(payload):
    ...
    try:
        from agents.agent1_sourcing.main import build_sourcing_catalog
...
def run_a7(payload):
    ...
    try:
        from agents.agent7_inventory.main import build_shopify_catalog
...
def run_a10(payload):
    ...
    try:
        from agents.agent10_competitor_analyst.main import scan_competitor_prices
